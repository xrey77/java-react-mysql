            ...
            .then(res => {
                if (res.data.statuscode === 200) {
                    ...
                    if (res.data.user.qrcodeurl === null) {
                        ...
                        sessionStorage.setItem('USERPIC', res.data.user.picture)
                        sessionStorage.setItem('USERMAIL', res.data.user.email)
                        sessionStorage.setItem('USERFULLNAME', res.data.user.firstname + " " + res.data.user.lastname)
                        window.setTimeout(() => {
                        ...
                        sessionStorage.setItem('TOKEN', res.data.user.token)
                        sessionStorage.setItem('USERPIC', res.data.user.picture)
                        sessionStorage.setItem('USERMAIL', res.data.user.emailadd)
                        sessionStorage.setItem('USERFULLNAME', res.data.user.firstname + " " + res.data.user.lastname)
                    }
